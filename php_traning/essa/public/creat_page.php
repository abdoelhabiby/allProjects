...
if($menu_id_selected){
  $_SESSION['idpage']=$menu_id_selected;}
  ...
  <div class="card">
    ...
    <div id="collapseOne<?php echo $keyarray['id'];?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
       ...
       <a href="creat_page.php?menu=<?php echo mysqli_real_escape_string($connect ,$keyarray['id']);?>"> 
    ...
    $fromdata1= mysqli_query($connect,$query1);
   $count_row1=mysqli_num_rows($fromdata1);
?>

    <ul style="list-style-type:none;">
     <li>
     <?php if($count_row1 == 0){echo "no pages"; }elseif($count_row1 ==1){echo "page: " . $count_row1;}else{echo "pages:" . $count_row1;} ?> 
     </li>
   </ul>
    ...
    "<q>" . "The field must be entered your page and the number of characters must be greater than 4 and less than 20" 
    . "</q><br><q>also in sucsess you will go to management else you will return yo page creat</q>";
...
<h4>creat new page</h4> 
    <form method="POST" action="page_submit.php">
  <div class="form-group">
    <label for="text">page group</label>
  ...
  <div class="form-group">
    <div class="radio">
      ...
      <label><input type="radio" name="optradio1" value='1'>yse</label>
  ...
  <select class="form-control" id="sel1">
           ...
           <?php
    $query2="SELECT RANK FROM pages WHERE item_name_id=".$menu_id_selected;
